...
import {выбратьФайл, породаКартинки, uploadReplacement, uploadReformat} from './images';
 ...
 * не виден — подписи там нет вовсе, слово владельца 2026-08-17) и меняет файл: любую картинку
 * тела статьи можно заменить любой другой — JPG, PNG или GIF (слово владельца 2026-08-18).
 * Та же порода идёт заменой байтов, другая — сменой формата с новым расширением и обновлённой
 * ссылкой; при занятом имени сервер берёт следующее свободное.
 *
