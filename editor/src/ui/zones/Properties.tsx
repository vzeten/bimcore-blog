        ...
        <div className="props-grid">
          {поля.map((field, index) => (
            <label key={field.key}>
              ...
              {/* Почему поле не правится — словами, иначе человек решит, что программа сломалась. */}
              {field.kind === 'заперто' && <span className="props-locked">{props.settings.подписи.полеЗаперто}</span>}
