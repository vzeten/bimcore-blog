...
export function Properties(props: {
  ...
  // доступность страницы на сайте, и назначается оно только публикацией (решение владельца
  // 2026-09-18, п.3): выбор стоит в окне «Опубликовать», а в свойствах его нет. Поля в шапке
  // остаются механизмом сайта; их пишет публикация тем же правилом ядра (`core/siteAccess.mjs`).
  ...
  return (
    <section className="props">
      <button className="props-head" onClick={() => setOpen(!open)}>
        ...
        <span className="props-count">{обычные.length}</span>
      </button>
