...
export function строкаПричины(остановка: Остановка, settings: Settings): string {
  ...
  // Лишнее убрано: человек читает не «публиковать нечего», а что именно ушло в корзину.
  if (остановка.убрано.length > 0) return (п.причины[остановка.ключ] ?? остановка.ключ).replace('{файлы}', остановка.убрано.join(', '));
