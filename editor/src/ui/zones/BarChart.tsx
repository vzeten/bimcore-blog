 ...
 * — только числа; наведение на метку — короткая сводка по видам изменений. Щелчок по столбику или метке
 * выбирает период: полный список изменений и страницы за него показываются под графиками, без перехода
 * (слово владельца 2026-09-24). Браузерной подсказки нет: она всплывала вторым окном.
 */
