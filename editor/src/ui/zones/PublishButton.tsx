...
export function PublishButton(props: {
  ...
  const публикация = usePublish(
    ...
    (исход) => {
      ...
      // Лишние файлы ушли в корзину этой же публикацией. Говорятся ОБА факта разом: статья на сайте,
      // а названные окном файлы можно вернуть. Молчание здесь оставило бы человека с ощущением, что
      // обещанная уборка не случилась.
      else if ((исход.убрано ?? []).length > 0) props.onСообщить(п.опубликованоИУбрано.replace('{файлы}', (исход.убрано ?? []).join(', ')));
    },
