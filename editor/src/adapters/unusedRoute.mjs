...
// записи ход не доходит. Без этой ручки такой файл пролежал бы в папке до следующей правки статьи,
// хотя публикацию человек уже нажал. Чистка молчаливая (решение владельца 2026-09-21): ход после
// неё говорит прежнее «публиковать нечего», а найти файл можно в корзине.
//
