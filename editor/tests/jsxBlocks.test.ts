// Правила блоков статьи, записанных JSX-тегом. Имена проверок повторяют формулировки правил
// (SPEC 5.2): что разбирается, что остаётся текстом дословно и как блок попадает в статью.
