---
title: "Bed Revit Families User Guide"
slug: /guides/families/beds-for-revit
sidebar_label: "14 Beds"
sidebar_position: 14
description: "Bed families for Revit plus bedside tables, benches and wall panels: how the set is organised and how to place it in a project."
image: ./img-01.png
---
...
<ProductCard
  name="Bed Revit Families"
  description="Single, double and king-size beds — bed families ready to drop into your Revit project."
  image={productPreview}
  imageAlt="Beds Revit Families — set preview"
...
The **Winged headboard** parameter can be enabled with any headboard shape. For example, Box x1 is selected in the image above.

For the Winged box headboard shape, **Wings width** has no effect because its overall width depends on the **Headboard depth** value.
