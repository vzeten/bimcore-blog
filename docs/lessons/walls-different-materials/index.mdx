...
<YouTube id="vhiVY0EkPu4" title="How to Remove the Joint Line Between Walls of Different Materials on a Plan in Revit" uploadDate="2026-06-19" duration="126" description="Make walls of different materials read as one solid wall on a Revit plan: join them, set a coarse-scale solid fill, and apply Coarse detail to walls only." />
