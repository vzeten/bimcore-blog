...
sidebar_label: "Walls of different materials"
sidebar_position: 1
...
> Tip: add the chosen color to your palette (custom colors) so you can quickly apply the same shade to the second wall and to future projects.
